...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	try{
		...
		return myDie("Your votes is recorded! Please keep safe your anynomous secret code. <a href='verify.php?secret=". $secret_code . "'>".$secret_code."</a></br> The secret code is usable only for you and you can use it to verify your vote and make sure that your vote is counted. ",'success');
